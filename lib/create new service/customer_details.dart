...
class CostomerDetails extends StatefulWidget {
      static String tag = 'customer-details-page';

  @override
  _CostomerDetailsState createState() => _CostomerDetailsState();
}

class _CostomerDetailsState extends State<CostomerDetails> {
 ...
 return Scaffold(
   appBar: AppBar(
     ...
     floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
                        Navigator.of(context).pushNamed(ProductDetails.tag);

...
class ToBeVisited extends StatefulWidget {
    static String tag = 'to-be-visited';

  @override
  _ToBeVisitedState createState() => _ToBeVisitedState();
}

class _ToBeVisitedState extends State<ToBeVisited> {
  @override

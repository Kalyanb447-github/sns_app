...
class CompletedServiceList extends StatefulWidget {
    static String tag = 'completed-service-list';

  @override
  _CompletedServiceListState createState() => _CompletedServiceListState();
}

class _CompletedServiceListState extends State<CompletedServiceList> {
  @override

...
class PendingParts extends StatefulWidget {
    static String tag = 'pending-part-page';

  @override
  _PendingPartsState createState() => _PendingPartsState();
}

class _PendingPartsState extends State<PendingParts> {
  @override
